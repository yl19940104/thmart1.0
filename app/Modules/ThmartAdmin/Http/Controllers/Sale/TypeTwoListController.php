...
class TypeTwoListController extends Controller
{ 
    ...
    public function index(Request $request)
    {
        ...
        if (isset($param) && $param) {
            ...
            $res = DB::table('sku')
                ->select('itemSalePrice.id', 'item.goodsNumber', 'sku.skuNumber', 'startTime', 'endTime', 'category.title as categoryTitle', 'item.title', 'item.subTitle', 'sku.price', 'itemSalePrice.salePrice', 'itemSalePrice.type', 'brand.name as brandName', 'item.id as itemId')
        ...
        return view('thmartAdmin::Sale/typeTwoList', compact('compactData'));
    }
}
