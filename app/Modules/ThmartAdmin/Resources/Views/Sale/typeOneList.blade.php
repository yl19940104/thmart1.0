...
<body class="hold-transition skin-blue sidebar-mini">
          ...
          <form id="formData">
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="form-group">
                  <div class="form-group">
                  <label class="control-label">产品英文名</label>
            ...
            <div class="checkbox">
              <label>
                <input type="checkbox" name="onlySalePrice" @if (isset($compactData['get']['onlySalePrice']) && $compactData['get']['onlySalePrice'] == 'on') checked="" @endif>仅显示有促销价的商品
              </label>
            </div>
            <div class="checkbox">
              <label>
            ...
            @if (isset($compactData['data']))
              @foreach ($compactData['data'] as $v)
                <tr>
                  ...
                  <td class="col-xs-1">{{$v->goodsNumber}}</td>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" id="formData" style="margin-top:2%">
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-xs-12 col-md-3 control-label">促销价</label>
                  <div class="col-xs-12 col-md-6">
  ...
  <script src="/thmartAdmin/js/api/typeOneList.js"></script>
