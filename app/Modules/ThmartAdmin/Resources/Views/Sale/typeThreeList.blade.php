        ...
        <section class="content deals">
            <div class="order-form">
                <form id="formData">
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="onlySalePrice" @if (isset($compactData['get']['onlySalePrice']) && $compactData['get']['onlySalePrice'] == 'on') checked="" @endif>仅显示有拼单价的商品
                        </label>
                    </div>
                    <div class="checkbox">
                        <label>
                    ...
                    @if (isset($compactData['data']))
                        @foreach ($compactData['data'] as $v)
                            <tr>
                                ...
                                <td class="col-xs-1">{{$v->amount}}</td>
                                <td class="col-xs-1">
                                    @if (isset($v->id))
                                        <button type="submit" class="btn btn-default add" data-toggle="modal" data-target="#myModal" skuNumber="{{$v->skuNumber}}" goodsName="{{$v->title}}" price="{{$v->price}}" salePrice="{{$v->salePrice}}" startTime="{{$v->startTime}}" endTime="{{$v->endTime}}" typeValue="{{$v->type}}" saleEditId="{{$v->id}}" amount="{{$v->amount}}">修改</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" id="formData" style="margin-top:2%">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-xs-12 col-md-3 control-label">拼单价</label>
                                <div class="col-xs-12 col-md-6">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-xs-12 col-md-3 control-label">拼单人数</label>
                                <div class="col-xs-12 col-md-6">
...
<script src="/thmartAdmin/js/api/typeThreeList.js"></script>
